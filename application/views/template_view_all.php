{php_open} echo anchor('{nama_tabel}/add','add');{php_close}
<br>
{php_open} echo anchor('front','back');{php_close}
{php_open} echo form_open('{nama_tabel}/delete');{php_close}
...
<table border="1">
    ...
    {php_open} foreach (${nama_tabel}s as ${nama_tabel}) { {php_close}
        ...
        <tr>
           ...
           {/fields_tabel2}
            <td><a href="{php_open} echo site_url().'/{nama_tabel}/form_update/'.${nama_tabel}['{primary_key}'];{php_close}" >Edit</a>
        </tr>
 {/primary_key_tabel}
{php_open} } {php_close}
</table>
